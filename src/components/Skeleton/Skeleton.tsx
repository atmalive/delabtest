...
export const Skeleton = () => {
    return (
        <div className="relative max-w-sm mx-auto flex flex-col bg-gray-400 bg-opacity-30">
            ...
            <div
                className='mt-auto w-full bg-white rounded-tl-xl rounded-tr-xl py-3.5 bg-gradient-to-b from-blue-100 to-blue-50 opacity-50'>
                <Header/>
            ...
            <div
                className='flex flex-col bg-white px-3.5 py-5 gap-6 rounded-tl-3xl rounded-tr-3xl bg-gradient-to-b from-blue-50 to-white opacity-50'>
