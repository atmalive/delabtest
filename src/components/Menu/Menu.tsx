    ...
    return (
        ...
        >
            ...
            <label htmlFor="search"
                   className="relative flex items-center gap-2 bg-white border border-gray-300 rounded-full p-1 w-full">
                <input id="search" type="text" className="flex-1 outline-none px-2 w-full" placeholder="Message..."/>
